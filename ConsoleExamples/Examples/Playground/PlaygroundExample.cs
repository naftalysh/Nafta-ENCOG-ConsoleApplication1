...
namespace Encog.Examples.Playground
{
    ...
    {
        private static readonly FileInfo sourceCSV = new FileInfo("C:\\Users\\Jeff\\EncogProjects\\MyEncogProject\\large-test.csv");
        private static readonly FileInfo targetCSV = new FileInfo("C:\\Users\\Jeff\\EncogProjects\\MyEncogProject\\large-norm.csv");
        private static readonly FileInfo scriptEGA = new FileInfo("C:\\Users\\Jeff\\EncogProjects\\MyEncogProject\\large-test.ega");
