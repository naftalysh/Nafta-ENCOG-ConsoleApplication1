...
namespace Encog.ML.Data.Market.Loader
{
    public partial class CSVFormLoader : Form
    {
        ...
        private CSVFormat currentFormat;
        ...
        private Dictionary<string, CSVFormat> FormatDictionary = new Dictionary<string, CSVFormat>();
        private Dictionary<string, MarketDataType> MarketDataTypesToUse = new Dictionary<string, MarketDataType>();
        private string[] MarketDataTypesValues;
